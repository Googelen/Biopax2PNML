...
\todo[inline]{This is from papers.txt. Is this the correct place for this? Rewrite if necessary!}
    ...
    \todo{References are missing all over the place}(c.elegans paper)
    ...
    \todo{Add reference}(Feenstra) where it is explained how petri nets are formed and how they can be used to predict possible outcomes of experiments. These papers all are focused on the Caenorhabditis elegans.
...
\subsection{Static validation}\label{sec:static_validation}
    ...
    \todo{This list should become text.}
    \begin{description}
...
\section{Conclusions}\label{sec:conclusions}
    ...
    References:
    M Heiner, D Gilbert, R Donaldson, ‘Petri Nets for System and Synthetic Biology’, M Bernardo, P Degano and G Zavattaro (eds.): SFM 2008, Springer LNCS 5016, pp 215-264, 2008.\todo{Is that in the bibtex file already?}
